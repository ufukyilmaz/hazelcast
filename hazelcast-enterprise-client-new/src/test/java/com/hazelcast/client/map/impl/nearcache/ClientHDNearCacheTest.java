...
public class ClientHDNearCacheTest {
    ...
    public static void setup() throws Exception {
        ...
        maxSizeConfig.getEvictionConfig().setSize(MAX_CACHE_SIZE)
        ...
        randomMaxSizeConfig.setEvictionPolicy("LRU");
        ...
        noneMaxSizeConfig.setEvictionPolicy("LRU");
    ...
    public void testNearCacheMaxSize() {
        ...
        populateNearCache(map, 100000);

        HazelcastTestSupport.assertTrueEventually(new AssertTask() {
            @Override
            public void run() throws Exception {
                final NearCacheStats stats = map.getLocalMapStats().getNearCacheStats();
                assertTrue("100000 > " + stats.getOwnedEntryCount(), 100000 > stats.getOwnedEntryCount());
            }
        });
    }
    ...
    public void testNearCacheInvalidationWithLFU() throws Exception {
        ...
        assertTrueEventually(new AssertTask() {
            ...
            public void run() throws Exception {
                ...
                long ownedEntryCount = stats.getOwnedEntryCount();
                triggerEviction(map);
                assertTrue("owned entry count " + ownedEntryCount, 100000 > ownedEntryCount);
            }
        });
    }

...
public class ClientQueryCacheBasicTest extends HazelcastTestSupport {
    ...
    public void setup() {
        ...
        config.setLicenseKey(SampleLicense.ENTERPRISE_HD_LICENSE);

        ClientConfig clientConfig = new ClientConfig();
        clientConfig.setLicenseKey(SampleLicense.ENTERPRISE_HD_LICENSE);
        ...
        map = getEnterpriseMap(client, TEST_MAP_NAME);

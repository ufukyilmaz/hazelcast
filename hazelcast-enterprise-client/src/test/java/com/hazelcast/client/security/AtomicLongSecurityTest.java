...
public class AtomicLongSecurityTest {
    ...
    @Test
    public void testLegacyAtomicLongReadPermission() {
        final Config config = createConfig();
        addPermission(config)
                .addAction(ActionConstants.ACTION_CREATE)
                .addAction(ActionConstants.ACTION_READ);
        ...
        IAtomicLong atomic = client.getAtomicLong(testObjectName);
        assertEquals(0, atomic.get());
    }

    @Test
    public void testLegacyAtomicLongWritePermission() {
        final Config config = createConfig();
        addPermission(config)
                .addAction(ActionConstants.ACTION_CREATE)
                .addAction(ActionConstants.ACTION_MODIFY);
    ...
    @Test
    public void testLegacyAtomicLong_createFail_withoutPermission() {
        final Config config = createConfig();
        ...
        expectedException.expect(AccessControlException.class);
        client.getAtomicLong(testObjectName);
    }

    @Test
    public void testLegacyAtomicLong_modifyFail_withoutPermission() {
        final Config config = createConfig();
        addPermission(config)
                .addAction(ActionConstants.ACTION_CREATE);
    ...
    @Test
    public void testLegacyAtomicLong_readFail_withoutPermission() {
        final Config config = createConfig();
        addPermission(config)
                .addAction(ActionConstants.ACTION_CREATE);

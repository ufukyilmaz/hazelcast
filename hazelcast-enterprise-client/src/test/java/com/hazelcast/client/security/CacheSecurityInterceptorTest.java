...
public class CacheSecurityInterceptorTest extends BaseInterceptorTest {
    ...
    public void registerCacheEntryListener() {
        ...
        interceptor.setExpectation(getObjectType(), getNameWithPrefix(), "registerCacheEntryListener", new Object[]{});
    ...
    public void deregisterCacheEntryListener() {
        ...
        cache.registerCacheEntryListener(cacheEntryListenerConfig);
        interceptor.setExpectation(getObjectType(), getNameWithPrefix(), "deregisterCacheEntryListener", new Object[]{});

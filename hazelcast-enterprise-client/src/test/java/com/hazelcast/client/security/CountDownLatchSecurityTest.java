...
public class CountDownLatchSecurityTest {
    ...
    @Test
    public void testLegacyCountDownLatchReadPermission() {
        final Config config = createConfig();
        addPermission(config)
                .addAction(ActionConstants.ACTION_CREATE)
                .addAction(ActionConstants.ACTION_READ);
        ...
        ICountDownLatch latch = client.getCountDownLatch(testObjectName);
        assertEquals(0, latch.getCount());
    }

    @Test
    public void testLegacyCountDownLatchAcquirePermission() {
        final Config config = createConfig();
        addPermission(config)
                .addAction(ActionConstants.ACTION_CREATE)
                .addAction(ActionConstants.ACTION_MODIFY);
    ...
    @Test
    public void testLegacyCountDownLatch_createFail_withoutPermission() {
        final Config config = createConfig();
        ...
        expectedException.expect(AccessControlException.class);
        client.getCountDownLatch(testObjectName);
    }

    @Test
    public void testLegacyCountDownLatch_modifyFail_withoutPermission() {
        final Config config = createConfig();
        addPermission(config)
                .addAction(ActionConstants.ACTION_CREATE);
    ...
    @Test
    public void testLegacyCountDownLatch_readFail_withoutPermission() {
        final Config config = createConfig();
        addPermission(config)
                .addAction(ActionConstants.ACTION_CREATE);

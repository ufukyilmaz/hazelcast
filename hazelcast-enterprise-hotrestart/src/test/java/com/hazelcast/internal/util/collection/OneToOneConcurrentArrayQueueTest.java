...
public class OneToOneConcurrentArrayQueueTest {

    // must be a power of two to work
    private static final int CAPACITY = 1 << 2;

    private OneToOneConcurrentArrayQueue<Integer> queue = new OneToOneConcurrentArrayQueue<Integer>(CAPACITY);

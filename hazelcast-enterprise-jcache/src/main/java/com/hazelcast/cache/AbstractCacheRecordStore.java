...
import com.hazelcast.util.ArrayQueue;
...
//                cacheConfig.getEvictionPercentage(), cacheConfig.getEvictionThresholdPercentage());
    ...
    protected boolean contains(Data key) {
    ...
    void own(Data key, Data value, long ttlMillis) {
    ...
    protected Data getAndRemove(Data key, String caller) {
        Data oldValue = null;
    ...
    protected boolean remove(Data key, String caller) {
    ...
    public static class CacheRecordAccessor
        ...
        private final ArrayQueue<CacheRecord> recordQ = new ArrayQueue<CacheRecord>(1024);
        private final ArrayQueue<OffHeapData> dataQ = new ArrayQueue<OffHeapData>(1024);

 ...
 */
final class CacheEvictionOperation extends AbstractOperation implements PartitionAwareOperation {
    ...
    public void run() throws Exception {
        ...
        CacheRecordStore cache = cacheService.getCache(name, getPartitionId());
        if (cache != null) {

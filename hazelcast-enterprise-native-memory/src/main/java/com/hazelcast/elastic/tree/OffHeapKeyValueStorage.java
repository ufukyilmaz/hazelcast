...
public interface OffHeapKeyValueStorage {
     ...
     * @return address of the key entry, or zero address if not found
     */
    long getKeyEntry(long keyAddress, long keyWrittenBytes, long keyAllocatedBytes, boolean createIfNotExists);

    /***
     * Looking for key equal or closest to buffer by address;
     * keyAddress with params keyWrittenBytes and keyAllocatedBytes;
     * <p/>
     *
     * @param keyAddress        - address of the key
     ...
     */
    long searchKeyEntry(long keyAddress, long keyWrittenBytes, long keyAllocatedBytes);
     ...
     * @return address of the key entry
     */
    long getKeyEntry(long keyAddress, long keyWrittenBytes, long keyAllocatedBytes, OffHeapComparator comparator,
    ...
    /***
     * Removes an element specified by the key from the tree
     *
     * @param keyEntryPointer address of the key to remove
     */
    void remove(long keyEntryPointer);
}

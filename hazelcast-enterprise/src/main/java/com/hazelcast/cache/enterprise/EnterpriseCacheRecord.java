 ...
 */
public final class EnterpriseCacheRecord<V extends OffHeapData>
    ...
    public EnterpriseCacheRecord() {
    }

    public EnterpriseCacheRecord(long address) {
        super(address, SIZE);
    }
    ...
    public EnterpriseCacheRecord reset(long address) {
        setAddress(address);
        setSize(SIZE);
        return this;
    }
    ...
    public void clear() {
        ...
        setAccessTimeDiff(0);
        setTtlMillis(0);
        setValueAddress(EnterpriseCacheConstants.NULL_PTR);
    }

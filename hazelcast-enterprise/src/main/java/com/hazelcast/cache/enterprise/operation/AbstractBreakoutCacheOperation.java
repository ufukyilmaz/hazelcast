 ...
 */
abstract class AbstractBreakoutCacheOperation
    ...
    protected AbstractBreakoutCacheOperation(String name) {
        this.name = name;
    }

    protected AbstractBreakoutCacheOperation(String name, Data key) {
        this.name = name;
        this.key = key;
    }

    protected AbstractBreakoutCacheOperation(String name, int completionId) {
        this.name = name;
        this.completionId = completionId;
    }

    protected AbstractBreakoutCacheOperation(String name, Data key, int completionId) {
        this.name = name;
        this.key = key;
        this.completionId = completionId;
    }
    ...
    public final void beforeRun() throws Exception {
        ...
        try {
            ...
            cache = (BreakoutCacheRecordStore) service.getOrCreateCache(name, getPartitionId());

...
//        } else {
//            record.setValueAddress(OffHeapCacheRecordStore.NULL_PTR);
//        }
//        return record;
//    }
//
...
//                newPut = true;
//            } else {
//                if (record.getValueAddress() == OffHeapCacheRecordStore.NULL_PTR) {
...
//            if (newPut && record != null && record.address() != OffHeapCacheRecordStore.NULL_PTR) {
//                if (!records.delete(key)) {
//                    cacheRecordService.dispose(record);
//                }
//            }
//            if (newValue != null && newValue.address() != OffHeapCacheRecordStore.NULL_PTR) {
...
//            cacheRecordService.enqueueRecord(record);
//        } catch (OffHeapOutOfMemoryError e) {
//            if (record != null && record.address() != OffHeapCacheRecordStore.NULL_PTR) {
//                if (!records.delete(key)) {
//                    cacheRecordService.dispose(record);
//                }
//            }
...
//            if (valueAddress <= OffHeapCacheRecordStore.NULL_PTR) {
...
//            data.reset(OffHeapCacheRecordStore.NULL_PTR);
//            dataQ.offer(data);
//        }
//    }
//

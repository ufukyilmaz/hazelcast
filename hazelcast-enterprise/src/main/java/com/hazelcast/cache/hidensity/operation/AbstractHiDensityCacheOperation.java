    ...
    public final void beforeRun() throws Exception {
        ...
        try {
            if (dontCreateCacheRecordStoreIfNotExist) {
                cache = (HiDensityCacheRecordStore) cacheService.getCacheRecordStore(name, partitionId);
            } else {
                cache = (HiDensityCacheRecordStore) cacheService.getOrCreateCache(name, partitionId);
            }
        } catch (Throwable e) {
            dispose();

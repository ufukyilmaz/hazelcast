...
public interface EnterpriseMapCodecTemplate {
    ...
    @Request(id = 1, retryable = true, response = ResponseMessageConst.MAP_DATA_DATA)
    void publisherCreateWithValue(String mapName,
                                  String cacheName,
                                  Data predicate,
                                  int batchSize,
                                  int bufferSize,
    ...
    void publisherCreate(String mapName,
                         String cacheName,
                         Data predicate,
                         int batchSize,
                         int bufferSize,

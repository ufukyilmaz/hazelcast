 ...
 */
public final class ConcurrentLinkedOffHeapQueue<E> extends AbstractQueue<E> implements OffHeapQueue<E> {

    private final LongConcurrentLinkedQueue queue;
    private final EnterpriseSerializationService ss;

    public ConcurrentLinkedOffHeapQueue(EnterpriseSerializationService ss, MemoryAllocator malloc) {
        this.ss = ss;

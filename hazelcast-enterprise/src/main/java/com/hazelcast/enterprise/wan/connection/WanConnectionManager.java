...
public class WanConnectionManager {
    ...
    public static final int DEFAULT_DISCOVERY_TASK_PERIOD = 10;
    /** Default maximum number of endpoints to connect to */
    public static final int DEFAULT_MAX_ENDPOINTS = Integer.MAX_VALUE;
     ...
     * @param password               the password for the discovered endpoints
     * @param discoveryPeriodSeconds the period for the discovery task
     * @param maxEndpoints           the maximum number of endpoints to connect to
     */
    public void init(String groupName, String password, Integer discoveryPeriodSeconds, Integer maxEndpoints) {
    ...
    private List<Address> discoverPublicAddresses() {
        ...
        for (DiscoveryNode node : nodes) {
            addresses.add(node.getPublicAddress());
        }
        return addresses;
    }

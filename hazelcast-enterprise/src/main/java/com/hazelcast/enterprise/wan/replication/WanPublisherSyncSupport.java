 ...
 */
public class WanPublisherSyncSupport {
    ...
    WanPublisherSyncSupport(Node node, AbstractWanPublisher publisher) {
     ...
     */
    void removeReplicationEvent(EnterpriseMapReplicationSync sync) {

...
public class OffHeapByteArrayObjectDataInput implements OffHeapDataInput, ObjectDataInput {
    ...
    OffHeapByteArrayObjectDataInput(long dataAddress, long dataSize, SerializationService service, ByteOrder byteOrder) {
    ...
    public char readChar(long position) throws IOException {
        ...
        return OffHeapBits.readChar(dataAddress, position, bigEndian);
    }
    ...
    public int readInt(long position) throws IOException {
        ...
        return OffHeapBits.readInt(dataAddress, position, bigEndian);
    }
    ...
    public int readInt(long position, ByteOrder byteOrder) throws IOException {
        checkAvailable(position, INT_SIZE_IN_BYTES);
        return OffHeapBits.readInt(dataAddress, position, byteOrder == ByteOrder.BIG_ENDIAN);
    }
    ...
    public long readLong(long position) throws IOException {
        ...
        return OffHeapBits.readLong(dataAddress, position, bigEndian);
    }
    ...
    public long readLong(long position, ByteOrder byteOrder) throws IOException {
        checkAvailable(position, LONG_SIZE_IN_BYTES);
        return OffHeapBits.readLong(dataAddress, position, byteOrder == ByteOrder.BIG_ENDIAN);
    }
    ...
    public short readShort(long position) throws IOException {
        ...
        return OffHeapBits.readShort(dataAddress, position, bigEndian);
    }
    ...
    public short readShort(long position, ByteOrder byteOrder) throws IOException {
        checkAvailable(position, SHORT_SIZE_IN_BYTES);
        return OffHeapBits.readShort(dataAddress, position, byteOrder == ByteOrder.BIG_ENDIAN);
    }
    ...
    public final String readUTF() throws IOException {
        ...
        for (int i = 0; i < charCount; i++) {
            b = readByte();
            if (b < 0) {
                charBuffer[i] = OffHeapBits.readUtf8Char(this, b);
            } else {
                charBuffer[i] = (char) b;
            }
        }
    ...
    public String toString() {
        return "OffHeapByteArrayObjectDataInput{"
                + "size=" + size
                + ", pos=" + pos
                + '}';
    }

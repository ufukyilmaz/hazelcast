...
public class HDQueryPartitionWithIndexOperation extends HDMapOperation implements PartitionAwareOperation, ReadonlyOperation {

    private Query query;
    private Result result;

    public HDQueryPartitionWithIndexOperation() {
    }

    public HDQueryPartitionWithIndexOperation(Query query) {
    ...
    @Override
    public int getId() {
        return EnterpriseMapDataSerializerHook.QUERY_PARTITION_WITH_INDEX_OP;
    }
}

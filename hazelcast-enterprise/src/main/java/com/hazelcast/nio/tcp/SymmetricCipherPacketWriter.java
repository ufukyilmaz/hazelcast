...
//        }
//
//        if (!packetWritten && packetBuffer.hasRemaining()) {
//
//            //        if (packetBuffer.capacity() < packet.size()) {
//            //            packetBuffer = ByteBuffer.allocate(packet.size());
//            //        }
//            //        if (!packet.writeTo(packetBuffer)) {
//            //            throw new HazelcastException("Packet didn't fit into the buffer! " + packet.size() + " VS " + packetBuffer);
//            //        }
////            packetWritten = true;
//
//            packetWritten = packet.writeTo(packetBuffer);
//            packetBuffer.flip();
//        }
//

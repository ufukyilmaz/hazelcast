...
public class TopicSecurityTest {
    ...
    public void testTopicPublishPermissionPass() {
        ...
        client.getTopic(testObjectName).publish("value");
    }
    ...
    public void testTopicListenerPermissionPass() {
        ...
        factory.newHazelcastInstance(config);
        HazelcastInstance client = factory.newHazelcastClient();
        client.getTopic(testObjectName).addMessageListener(new MessageListener<Object>() {
            @Override
    ...
    private PermissionConfig addPermission(Config config, String name) {
        PermissionConfig perm = new PermissionConfig(PermissionConfig.PermissionType.TOPIC, name, "dev");

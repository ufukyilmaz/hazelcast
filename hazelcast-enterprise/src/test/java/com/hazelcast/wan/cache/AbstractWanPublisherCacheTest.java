...
public abstract class AbstractWanPublisherCacheTest extends WanCacheTestSupport {
    ...
    public void testStopResume() {
        ...
        assertWanPublisherStateEventually(clusterA, wanReplicationConfigName, targetClusterName, WanPublisherState.STOPPED);
        createCacheDataIn(clusterA, DEFAULT_CACHE_NAME, 50, 100, false);
        checkKeysNotIn(clusterB, DEFAULT_CACHE_NAME, 50, 100);
        assertWanQueueSizesEventually(clusterA, wanReplicationConfigName, targetClusterName, 0);
    ...
    public void testPublisherInitialStateStopped() {
        ...
        final WanBatchPublisherConfig pc = configA.getWanReplicationConfig(wanReplicationConfigName)
    ...
    public void testPublisherInitialStatePaused() {
        ...
        WanBatchPublisherConfig pc = configA.getWanReplicationConfig(wanReplicationConfigName)
                                            .getBatchPublisherConfigs()
                                            .get(0);

...
public class WanBatchPublisherCacheTest extends AbstractWanPublisherCacheTest {
    ...
    public void recoverFromConnectionFailure() {
        initConfigA();
        //configA.setProperty(ClusterProperty.ENTERPRISE_WAN_REP_QUEUE_CAPACITY, "100");
        initConfigB();

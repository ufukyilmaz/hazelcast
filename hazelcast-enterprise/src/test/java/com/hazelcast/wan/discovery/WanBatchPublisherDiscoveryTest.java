...
import com.hazelcast.wan.map.WanMapTestSupport;
...
public class WanBatchPublisherDiscoveryTest extends WanMapTestSupport {
    ...
    public void testMaxConnected() {
        ...
        WanBatchPublisherConfig publisherConfig = c.getBatchPublisherConfigs().iterator().next();
    ...
    private <T extends DiscoveryStrategyFactory> T setupDiscoveryStrategyFactory(
            ...
            Consumer<WanBatchPublisherConfig> publisherConfigConsumer) {
        ...
        WanReplicationConfig wanReplicationConfig = configA.getWanReplicationConfig(wanReplicationName);
        WanBatchPublisherConfig pc = wanReplicationConfig.getBatchPublisherConfigs().iterator().next();
    ...
    private List<Address> getTargetEndpoints() {
        ...
        final WanBatchPublisher endpoint = (WanBatchPublisher) wanReplicationService.getPublisherOrFail(
                wanReplicationName, configB.getClusterName());

...
public class WanBatchPublisherMapQuickTest extends WanMapTestSupport {
    ...
    public void testPublisherProperties() {
        ...
        WanReplicationConfig wanReplicationConfig = propTestConfig.getWanReplicationConfig("atob");
        WanBatchPublisherConfig pc = wanReplicationConfig.getBatchPublisherConfigs().get(0);
        pc.setBatchSize(500)
    ...
    public void testClearQueues() {
        ...
        WanBatchPublisher publisher =
                (WanBatchPublisher) wanReplicationService.getPublisherOrFail("atob", configB.getClusterName());

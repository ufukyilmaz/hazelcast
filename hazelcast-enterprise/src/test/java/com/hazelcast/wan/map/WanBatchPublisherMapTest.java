...
public class WanBatchPublisherMapTest extends WanMapTestSupport {
    ...
    public void failStartupWhenEndpointsAreMisconfigured() {
        ...
        List<WanBatchPublisherConfig> configs = configA.getWanReplicationConfig(publisherSetup)
                                                       .getBatchPublisherConfigs();
        for (WanBatchPublisherConfig publisherConfig : configs) {
    ...
    private int getOutboundQueueSizeFromReplicationInstance(HazelcastInstance instance,
        ...
        DelegatingWanScheme publisherDelegate = wanReplicationService
                .getWanReplicationPublishers(setupName);
        WanBatchPublisher wanBatchReplication = (WanBatchPublisher) publisherDelegate.getPublisher(publisherName);
    ...
    public void testPublisherInitialStateStopped() {
        ...
        WanBatchPublisherConfig targetClusterConfig = configA.getWanReplicationConfig("atob")
                                                             .getBatchPublisherConfigs()
                                                             .get(0);
    ...
    public void publisherIdOverridesClusterName() {
        ...
        List<WanBatchPublisherConfig> publisherConfigs = configA.getWanReplicationConfig(wanReplicationScheme)
                                                                .getBatchPublisherConfigs();
    ...
    public void duplicatePublisherConfigThrowsException() {
        ...
        WanReplicationConfig wanReplicationConfig = configA.getWanReplicationConfig(wanReplicationScheme);
        wanReplicationConfig.getBatchPublisherConfigs().clear();
        WanCustomPublisherConfig pc = new WanCustomPublisherConfig()
                .setPublisherId("publisherId")
                .setClassName(UninitializableWanPublisher.class.getName());

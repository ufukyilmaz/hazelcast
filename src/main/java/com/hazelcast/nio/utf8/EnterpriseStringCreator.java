...
import com.hazelcast.enterprise.util.JvmUtil;
...
public final class EnterpriseStringCreator {
    ...
    private EnterpriseStringCreator() {
    }

    public static UTFEncoderDecoder.StringCreator findBestStringCreator() {
    ...
    public static UTFEncoderDecoder.StringCreator findBestStringCreator(boolean faststringEnabled, boolean java8Enabled,
        ...
        try {
            ...
            if (java8Enabled && isOracleJava8(debugEnabled)) {
                if ((internalBcelEnabled || bcelEnabled) && isBcelAvailable(debugEnabled)) {
                    ...
                    UTFEncoderDecoder.StringCreator stringCreator = tryLoadBcelJava8StringCreator(internal, debugEnabled);
                ...
                if (asmEnabled && isAsmAvailable(debugEnabled)) {
                    UTFEncoderDecoder.StringCreator stringCreator = tryLoadAsmJava8StringCreator(debugEnabled);
                    if (stringCreator != null) {
                        return stringCreator;
                    }
                }
                ...
                if (javassistEnabled && isJavassistAvailable(debugEnabled)) {
                    UTFEncoderDecoder.StringCreator stringCreator = tryLoadJavassistJava8StringCreator(debugEnabled);
                    if (stringCreator != null) {
                        return stringCreator;
                    }
                }
            ...
            if (MAGIC_CLASSLOADER != null) {
                if ((internalBcelEnabled || bcelEnabled) && isBcelAvailable(debugEnabled)) {
                    boolean internal = internalBcelEnabled
                            && (isOracleBcelAvailable(debugEnabled) || isIBMBcelAvailable(debugEnabled));
                    UTFEncoderDecoder.StringCreator stringCreator = tryLoadBcelMagicAccessorStringCreator(internal, debugEnabled);
                    if (stringCreator != null) {
                        return stringCreator;
                    }
                }
                ...
                if (asmEnabled && isAsmAvailable(debugEnabled)) {
                    UTFEncoderDecoder.StringCreator stringCreator = tryLoadAsmMagicAccessorStringCreator(debugEnabled);
                    if (stringCreator != null) {
                        return stringCreator;
                    }
                }
                ...
                if (javassistEnabled && isJavassistAvailable(debugEnabled)) {
                    UTFEncoderDecoder.StringCreator stringCreator = tryLoadJavassistMagicAccessorStringCreator(debugEnabled);
                    if (stringCreator != null) {
                        return stringCreator;
                    }
                }
    ...
    private static UTFEncoderDecoder.StringCreator tryLoadAsmJava8StringCreator(boolean debugEnabled) {
        return loadStringCreator("com.hazelcast.nio.utf8.AsmJava8JlaStringCreatorBuilder", debugEnabled);
    }

    private static UTFEncoderDecoder.StringCreator tryLoadAsmMagicAccessorStringCreator(boolean debugEnabled) {
    ...
    private static UTFEncoderDecoder.StringCreator tryLoadJavassistJava8StringCreator(boolean debugEnabled) {
        return loadStringCreator("com.hazelcast.nio.utf8.JavassistJava8JlaStringCreatorBuilder", debugEnabled);
    }

    private static UTFEncoderDecoder.StringCreator tryLoadJavassistMagicAccessorStringCreator(boolean debugEnabled) {
    ...
    private static UTFEncoderDecoder.StringCreator tryLoadBcelJava8StringCreator(boolean internal, boolean debugEnabled) {
        String classname;
        if (internal) {
    ...
    private static UTFEncoderDecoder.StringCreator tryLoadBcelMagicAccessorStringCreator(boolean internal, boolean debugEnabled) {
        String classname;
        if (internal) {
            if (IS_ORACLE_JVM) {
    ...
    private static UTFEncoderDecoder.StringCreator loadStringCreator(String classname, boolean debugEnabled) {
        try {
            Class<?> builderClass = Class.forName(classname);
            StringCreatorBuilder builder = (StringCreatorBuilder) builderClass.newInstance();
            UTFEncoderDecoder.StringCreator stringCreator = builder.build();
